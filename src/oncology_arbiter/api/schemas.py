...
class ModelState(str, Enum):
    ...
    LOADED_MONAI_DETECTOR = "loaded_monai_detector"  # L4a MONAI detector (mask-gradient heuristic, weights_loaded=False)
    PROXY_MONAI_HEURISTIC = "proxy_monai_heuristic"  # L4a mask-gradient proxy when weights unavailable
